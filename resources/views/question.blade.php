...
@section('content')
    <span style="float: left">
        <a style="width: 120px" class="btn btn-block btn-info" href="{{url('admin/addQuestion')}}?abilityId={{$abilityId}}">新增问题</a>
    </span>
                        ...
                        @forelse($data as $value)
                            <tr>
                                ...
                                <td style="cursor:pointer;width: 150px">
                                    <a href="{{url('admin/editQuestion')}}?id={{$value->Id}}" style=" width:60px; float: left;margin-top: 5.9px;margin-right: -20px"  class="btn btn-block btn-info">编辑</a>
